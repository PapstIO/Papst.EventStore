...
public class InMemoryLowLevelEventStreamTests : IClassFixture<InMemoryTestFixture>
{
  private readonly InMemoryTestFixture _fixture;
  public InMemoryLowLevelEventStreamTests(InMemoryTestFixture fixture) => _fixture = fixture;
