...
public class FileSystemLowLevelEventStreamTests : IClassFixture<FileSystemTestFixture>
{
  private readonly FileSystemTestFixture _fixture;

  public FileSystemLowLevelEventStreamTests(FileSystemTestFixture fixture) => _fixture = fixture;
