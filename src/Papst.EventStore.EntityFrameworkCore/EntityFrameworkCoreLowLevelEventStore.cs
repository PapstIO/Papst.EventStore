...
public sealed class EntityFrameworkCoreLowLevelEventStore : ILowLevelEventStore
{
  private readonly ILogger<EntityFrameworkCoreLowLevelEventStore> _logger;
  private readonly ILoggerFactory _loggerFactory;
  private readonly IEventTypeProvider _eventTypeProvider;
  private readonly EventStoreDbContext _dbContext;

  public EntityFrameworkCoreLowLevelEventStore(
    ILogger<EntityFrameworkCoreLowLevelEventStore> logger,
  ...
  public async Task<ILowLevelEventStream> CreateAsync(Guid streamId, string targetTypeName,
