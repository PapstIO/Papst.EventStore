...
public class InMemoryLowLevelEventStore : ILowLevelEventStore
{
  private readonly Dictionary<Guid, InMemoryEventStream> _streams = new();
  private readonly TimeProvider _timeProvider;
  private readonly IEventTypeProvider _eventTypeProvider;

  public InMemoryLowLevelEventStore(TimeProvider timeProvider, IEventTypeProvider eventTypeProvider)
  {
    _timeProvider = timeProvider;
    _eventTypeProvider = eventTypeProvider;
  }

  public Task<ILowLevelEventStream> GetAsync(Guid streamId, CancellationToken cancellationToken = default)
  {
  ...
  public Task<ILowLevelEventStream> CreateAsync(Guid streamId, string targetTypeName,
  ...
  public Task<ILowLevelEventStream> CreateAsync(Guid streamId, string targetTypeName, string? tenantId, string? userId,
    string? username,
