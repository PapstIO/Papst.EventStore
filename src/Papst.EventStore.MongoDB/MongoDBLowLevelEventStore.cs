...
public class MongoDBLowLevelEventStore : ILowLevelEventStore, System.IDisposable
{
  ...
  private readonly ILogger<MongoDBLowLevelEventStore> _logger;
  ...
  public MongoDBLowLevelEventStore(
    ILogger<MongoDBLowLevelEventStore> logger,
  ...
  private static void RegisterConventions()
  {
    lock (_conventionLock)
    {
      ...
      BsonSerializer.RegisterSerializer(typeof(JObject), new JObjectBsonSerializer());
  ...
  public Task<ILowLevelEventStream> CreateAsync(
    Guid streamId,
